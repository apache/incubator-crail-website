...
The poor network usage matches with the general observation we made in our previous [HotNets'16 publication](http://dl.acm.org/citation.cfm?id=3027062) where we show that a faster network does not necessarily lead to a better runtime.

<br>
<div style="text-align:center"><img src ="http://crail.io/img/blog/sort/cpu_network.png" width="490" /></div>
<br><br>
