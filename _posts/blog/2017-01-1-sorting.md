...
<br>
<div style="text-align:center"><img src ="http://crail.io/overview/net_vanilla.svg" /></div>
<br><br>
...
<div style="text-align: justify"> 
<p>
Consequently, to improve the runtime of the sorting benchmark and to make good use of the 100Gbit/s network, the amount of CPU instructions executed by byte transferred need to be reduced massively. In the following, we show how we use the Crail shuffle engine to cut down the software overheads related to networking, deserialization and sorting and thereby empower reduce tasks in the sorting benchmark to consume data at the speed very close the network limit (~70Gbit/s all-to-all). 
</p>
</div>
