...
The poor network usage matches with the general observation we made in a [HotNets'16 publication](http://dl.acm.org/citation.cfm?id=3027062) where we show that a faster network does not necessarily lead to a better runtime.
